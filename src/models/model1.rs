...
pub fn model1() -> SolModel {
    ...
    ret.data.push(SDataTypes::SolisU32(Point { name: "AC output type", offset: 3, length: 1, write_access: false, value: 0 } ));
    ret.data.push(SDataTypes::SolisU32(Point { name: "DC output type", offset: 4, length: 1, write_access: false, value: 0 } ));
